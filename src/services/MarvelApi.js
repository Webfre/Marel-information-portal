...
const useMarvelApi = () => {
    ...
    const _apiKey = 'apikey=25e4bad5b4e25ccd82b5b21cfd99aaf8';
    const _baseOffset = 210

    const getAllCharacrers = async (offset = _baseOffset) => {
    ...
    // Трансформируем получаемый результат API
